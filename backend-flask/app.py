...
from utils.cognito_verify import TokenVerification, extract_access_token, TokenVerifyError, FlaskAWSCognitoError
# Cloud watch logs
import watchtower
import logging
...
cognito_token_verification = TokenVerification(
...
# HoneyComb configs starts
FlaskInstrumentor().instrument_app(app)
RequestsInstrumentor().instrument()
# HoneyComb configs ends
